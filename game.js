...
function openAccountPanel(kind) {
    ...
    if (kind === 'hero') {
        ...
        content.innerHTML = `<div class="feedback-box"><div class="feedback-heading">v3.5.10 · 百天签到更新</div><div>更新时间：2026 年 8 月 10 日</div></div><div class="skill-card"><div class="skill-name">✨ 新增内容</div><div class="skill-desc">• 新增完成新手七日签到后开启的百天签到。<br>• 大厅新增皮肤图鉴：只展示额外皮肤，并显示品质与收藏进度。<br>• 英雄选择页分为“已拥有英雄”和“未拥有英雄”，可按品质从低到高或从高到低排序。<br>• 大厅新增全屏按钮与更新公告入口。<br>• 大厅玩家信息下方新增创作者微信反馈方式；打不开 GitHub 时可通过微信联系，备注“吞噬模拟器玩家”。</div></div><div class="skill-card"><div class="skill-name">⚖️ 玩法调整</div><div class="skill-desc">• 排位与进化试炼存档可继续挑战；放弃存档会按当前到达层数结算星数。<br>• 变色龙已从英雄库下架，首次进入新版会收到 620 金币补偿邮件。<br>• 百天签到活动截止：2026 年 12 月 1 日 00:00（北京时间）。</div></div><div class="skill-card"><div class="skill-name">🔧 优化修复</div><div class="skill-desc">• 优化树木和石头间的 AI 脱困。<br>• 优化玩家头顶箭头与进化后的皮肤外观显示。<br>• 修复皮肤图鉴错误显示英雄默认外观的问题。</div></div>`;
